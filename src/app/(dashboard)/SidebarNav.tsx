      ...
      {sidebarItems.map(item => {
        ...
        return (
          <Link key={item.href} href={item.href} style={{
            ...
            color: active ? '#009EDB' : '#9BA8BC',
            fontSize: 13, fontWeight: 500,
            textDecoration: 'none',
            background: active ? 'rgba(0,158,219,0.12)' : 'transparent',
            border: active ? '1px solid rgba(0,158,219,0.2)' : '1px solid transparent',
            transition: 'all .12s',
          }}>
            <svg style={{ width: 16, height: 16, opacity: active ? 1 : 0.7, flexShrink: 0 }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
