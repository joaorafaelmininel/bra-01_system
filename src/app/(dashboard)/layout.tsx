...
const TOPBAR_H  = 52
const BANNER_H  = 28
const HEADER_H  = TOPBAR_H + BANNER_H   // 80px
const SIDEBAR_W = 200
    ...
    <EstadoProvider>
      ...
      >
        ...
        <header style={{
          ...
          height: TOPBAR_H, padding: '0 16px', gap: 0,
        }}>
          {/* Brand */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginRight: 16, flexShrink: 0 }}>
            ...
            <div style={{ marginLeft: 4 }}>
              <div style={{ fontFamily: 'var(--font-cond)', fontSize: 14, fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#fff', lineHeight: 1 }}>
                BRA-01 Heavy USAR
              </div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: 8, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#5A6478', marginTop: 2 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0, marginLeft: 12 }}>
            ...
            <div style={{
              ...
              fontFamily: 'var(--font-cond)', fontSize: 11, fontWeight: 700, color: '#fff',
            }}>
              {initials}
            </div>
        ...
        {/* ── SUBBANNER ── */}
        <div style={{
          background: '#004B87', padding: '0 16px',
          height: BANNER_H,
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {[
              { label: 'CBMMG',   state: 'Minas Gerais' },
              { label: 'CBMPR',   state: 'Paraná' },
              { label: 'CBPMESP', state: 'São Paulo' },
            ].map(c => (
              <div key={c.label} style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: 8, fontWeight: 600, padding: '2px 6px', borderRadius: 2, background: 'rgba(255,255,255,0.15)', color: '#fff', letterSpacing: '0.08em' }}>
                  {c.label}
                </span>
        ...
        <div style={{ display: 'flex', minHeight: `calc(100vh - ${HEADER_H}px)` }}>
          ...
          <aside style={{
            ...
            overflowY: 'auto', overflowX: 'hidden',  // ← evita expansão horizontal
          }}>
            {/* User info */}
            <div style={{ padding: '18px 14px 14px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
              <div style={{
                ...
                background: '#004B87', border: '1.5px solid #009EDB',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontFamily: 'var(--font-cond)', fontSize: 13, fontWeight: 700, color: '#fff',
                marginBottom: 10,
              }}>
                {initials}
              </div>
              <div style={{ fontFamily: 'var(--font-cond)', fontSize: 13, fontWeight: 700, color: '#E8EDF5', letterSpacing: '0.04em', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {displayName}
              </div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: '#5A6478', marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {user.email}
              </div>
            </div>
            ...
            <nav style={{ padding: '10px 6px', flex: 1 }}>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: 8, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#2E3848', padding: '0 6px', marginBottom: 6 }}>
                Navegação
              </div>
            ...
            <div style={{ padding: '10px 6px', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
              <form action={logout}>
                <button type="submit" style={{
                  ...
                  width: '100%', padding: '7px 6px', borderRadius: 4,
                  cursor: 'pointer', background: 'none', border: 'none',
                  fontFamily: 'var(--font-cond)', fontSize: 11, fontWeight: 600,
                  letterSpacing: '0.08em', textTransform: 'uppercase', color: '#5A6478',
                }}>
