...
const navItems = [
  ...
  { label: 'Conhecimento',  href: '/treinamento' },
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <div style={{ width: 4, height: 32, borderRadius: 1, background: '#CC0000' }} />
              <div style={{ width: 4, height: 32, borderRadius: 1, background: '#E87722', margin: '0 2px' }} />
              <div style={{ width: 4, height: 32, borderRadius: 1, background: '#009EDB' }} />
            </div>
